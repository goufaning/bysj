...
<html>
<head>
<title>Majestic Login Form Flat Responsive widget Template :: 小贝壳网站模板</title>
    ...
    <div id="wrapper">
        <div id="login" class="animate form">
			<form  action="#" method="post" autocomplete="on"> 
                <h2>登陆</h2>
                <p> 
					<label for="username" class="uname" data-icon="u" ><span>用户名/邮箱</span></label>
                    <input id="username" name="username" required="required" type="text" placeholder="EMAIL OR USERNAME"/>
                </p>
                <p> 
                    <label for="password" class="youpasswd" data-icon="p"><span>密码</span></label>
...
<p class="agileits">© 2016 Majestic Login Form. All Rights Reserved | Design by <a href="http://www.smallseashell.com/" target="_blank">小贝壳网站模板</a></p>  
</body>
</html>
